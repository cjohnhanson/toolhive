...
// fail the validator that runs downstream in buildPureOAuth2Config (added
// in commit 7dc73f89). The caller's *original* OAuth2Config is unaffected
// because buildUpstreamConfigs deep-copies before resolution; only the
// post-resolution copy is mutated here.
//
